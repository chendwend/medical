...
def prepare_dataloader(dataset: ImageFolder, batch_size: int) -> DataLoader:
...
def get_dataloaders(task_parent_dir, image_size:tuple[int, int], norm_params:dict, batch_size:int, testing=False):
