...
def prepare_dataloader(dataset: ImageFolder, batch_size: int, world_size:int, rank:int, num_workers:int) -> DataLoader:
...
def get_dataloaders(task_parent_dir:Union[str, Path], 
    ...
    train_loader = prepare_dataloader(train_dataset, batch_size, world_size, rank, num_workers)
    val_loader   = prepare_dataloader(val_dataset, batch_size, world_size, rank, num_workers)
    test_loader  = prepare_dataloader(test_dataset, batch_size, world_size, rank, num_workers)
